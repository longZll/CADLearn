...
namespace ObjectRule
{
    public class Commands : IExtensionApplication
    {
        ...
        private static ObjectRule objectRule;//对象重定义
        ...
        public void Initialize()
        {
            ...
            if (objectRule == null)
            {
                objectRule = new ObjectRule();
                //为直线类添加对象重定义
                Overrule.AddOverrule(RXObject.GetClass(typeof(Line)), objectRule, false);
                //添加扩展数据过滤，只重定义有Door扩展数据的直线
                objectRule.SetXDataFilter(appName);
            }
