...
namespace DotNetARX
{
    ...
    public static class TextTools
    {
        ...
        {
            //打开文字样式表记录
            TextStyleTableRecord str=(TextStyleTableRecord)txt.TextStyle.GetObject(OpenMode.ForRead);
            //必须保证文字为写的状态
        ...
        public static void SetFromTextStyle(this MText mtxt)
        {
            ...
            TextStyleTableRecord str=(TextStyleTableRecord)trans.GetObject(mtxt.TextStyle, OpenMode.ForRead);
